      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          ...
          <input
            ...
            placeholder="주간회의"
            className={`w-full rounded-[10px] border px-3.5 py-3 text-[16px] font-bold outline-none placeholder:font-normal placeholder:text-ink-disabled focus:ring-2 focus:ring-brand-100 ${
              titleErr
